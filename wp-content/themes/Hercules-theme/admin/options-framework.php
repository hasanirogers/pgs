...
function optionsframework_add_page() {
	...
	$of_page = add_menu_page('hercules Options', 'hercules Options', 'edit_theme_options', 'options-framework', 'optionsframework_page', OPTIONS_FRAMEWORK_DIRECTORY.'images/hercules-icon.png', 61);
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Hercules Options', 'options_framework_theme' ),

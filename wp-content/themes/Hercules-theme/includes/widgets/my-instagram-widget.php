...
<div id="instagram">
	...
	foreach ($result->data as $post){ ?>
		...
		<a title="<?php if ( isset($instance['show_caption'])){ if(!empty($post->caption->text)){ echo $post->caption->text; }} ?>" class="thumbnail" rel="prettyPhoto[instagram]" href="<?= $post->images->standard_resolution->url ?>"><img src="<?= $post->images->thumbnail->url ?>" alt="<?php if ( isset($instance['show_caption'])){ if(!empty($post->caption->text)){ echo $post->caption->text; }} ?>"><span class="zoom-insta"><?php if ( isset($instance['show_caption'])){ if(!empty($post->caption->text)){ echo '<div class="instagram_caption">'.$post->caption->text.'</div>'; }} ?></span></a>

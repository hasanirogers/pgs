...
<ul class="posts-grid row-fluid unstyled "><?php elseif($counter==2): ?><?php endif; ?>
...
<?php if($counter==2): ?></ul><!-- /.row cols2 -->
<?php $counter=0;endif;$counter++;endwhile;if($counter==2):?><!-- /.row cols2 --><?php endif;endif; ?>

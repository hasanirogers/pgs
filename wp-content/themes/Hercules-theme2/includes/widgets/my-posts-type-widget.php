...
function widget($args, $instance) {
  ...
  $valid_sort_orders = array('date', 'title', 'hs_comment_count', 'rand');
  ...
  $cat_posts = new WP_Query($args);
    ...
    ?>
        ...
        if(has_post_thumbnail()) {
          ...
          <?php if ( $instance['thumb_as_link'] ) : ?>
            ...
            <?php if($instance['thumb_w']!=="" || $instance['thumb_h']!==""){
              ...
              <img class="img-circle" src="<?php echo $image['url']; ?>" width="<?php echo $thumb_w ?>" height="<?php echo $thumb_h ?>" alt="<?php the_title(); ?>" />
            <?php }else{?>
	  ...
	  <?php if ( $instance['comment_num'] ) : ?>
        <span class="post-list_comment"><?php comments_number(); ?></span><br />
      <?php endif; ?>
			<?php if ($instance['posttype'] == "testi") { ?>
...
?>
  ...
  <p>
      <label>
          <?php _e( 'Posts type', HS_CURRENT_THEME ); ?>:
          <?php $args=array(); ?>
...
<p>
  ...
  <?php _e('Sort by', HS_CURRENT_THEME); ?>:
    <select id="<?php echo $this->get_field_id("sort_by"); ?>" name="<?php echo $this->get_field_name("sort_by"); ?>">
      <?php
        $options = array('date', 'title', 'hs_comment_count', 'rand');

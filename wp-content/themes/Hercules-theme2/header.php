...
<head>
	...
	} elseif ( is_home() || is_front_page() && of_get_option('sitetitle') == '') {
...
if ( is_active_sidebar( 'hs_header_sidebar_1' ) || is_active_sidebar( 'hs_header_sidebar_2' ) )  {
$hercules_holder = 'margin-top:166px;';
}else{
$hercules_holder = 'margin-top:109px;';
}
...
<header class="<?php echo $hercules_header_position; ?>" style="<?php echo $hercules_headerstyling; ?>">
	<div class="container">
		<div class="row-fluid">
			<div class="span12">

		...
		"tinymce.plugins.HS_Shortcodes",
		{
			init: function(d,e) {
				...
				// container
								...
								var a = '[container]'+selectedText+'[/container]';
                ...
                // Accordion
								...
								var a = '[accordions] [accordion title="title1"] tab content [/accordion] [accordion title="title2"] another content tab [/accordion] [/accordions]';
						...
						if(d=="shortcodes_button"){
							...
							d=e.createMenuButton("shortcodes_button",{
								...
								c=b.addMenu({title:"Posts"});
										...
										a.addWithDialog(c,"OurStaff Grid","ourstaff_grid");
										a.addWithDialog(c,"Services Grid","services_grid");
								...
								c=b.addMenu({title:"Basic"});b.addSeparator();
										...
										a.addWithDialog(c,"Clientslist","clientslist");

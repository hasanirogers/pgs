...
// Tweet author avatar
if (is_array($user) && array_key_exists('profile_image_url', $user) ) {
...
if ( isset($avatar) && $instance['isicon']) {
...
$instance['isicon']     = strip_tags( $new_instance['isicon'] );
...
<p>
  <label for="<?php echo $this->get_field_id("isicon"); ?>">
      <input type="checkbox" class="checkbox" id="<?php echo $this->get_field_id("isicon"); ?>" name="<?php echo $this->get_field_name("isicon"); ?>"<?php checked( (bool) $instance["isicon"], true ); ?> />
      <?php _e( 'Show profile icon', HS_CURRENT_THEME ); ?>
  </label>
</p>
<p>

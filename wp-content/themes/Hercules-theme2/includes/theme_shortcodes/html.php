  ...
  var marker = new google.maps.Marker({
      ...
      title: "'.$title.'"
				...
				function loadScript() {
					...
					script.src = "https://maps.googleapis.com/maps/api/js?callback=initialize&key=AIzaSyBSlHF64SqDmArp_9Qrgw0Yre5rXoSQkmg";
...
function icon_shortcode($atts, $content = null) {
    ...
    if ($icons != '') {
        $output = '<i class="'. $icons .' align'. $align .' '. $size .'"></i>';
        return $output;
    }    
}

	...
	class myWidget_Data {
		...
		function export_settings_page() {
			...
			<div class="widget-data export-widget-settings">
				<div class="wrap">
					<h4 class="head"><?php _e( '<span>Step <i>1</i></span> Widget Settings Export', HS_CURRENT_THEME ); ?></h4>	
		...
		function import_settings_page() {
			...
			<div class="widget-data import-widget-settings">
				<h4 class="head"><?php _e( '<span>Step <i>1</i></span> Widget Settings Import', HS_CURRENT_THEME ); ?></h4>					
					...
					<form action="" id="import-widget-data" method="post">
						...
						if (isset ($json_data[0])) : ?>
							...
							<input class="button-primary" type="submit" name="import-widgets" id="import-widgets" value="<?php _e( 'Import Settings', HS_CURRENT_THEME ); ?>">
							<?php else :
								echo __( 'Incorrect file. Please, <a href="admin.php?page=options-framework-import&amp;step=1">try again</a>.', HS_CURRENT_THEME );
								endif; ?>							
					...
					<?php else : ?>
						<form action="" id="upload-widget-data" method="post" enctype="multipart/form-data">
							...
							<input type="submit" name="button-upload" class="button-primary" value="<?php _e( 'Show Widget Settings', HS_CURRENT_THEME ); ?>" disabled="disabled">
						</form>
					<?php endif; ?>
	...
	//					unset($sidebars_data[$import_sidebar]);  // remove old sidebar array in the import data
		...
		function get_widget_settings_json() {
			...
			if (array_key_exists('error', $widget_settings)){
		        echo '<b>Error:</b> ' . $widget_settings['error'];
		    }

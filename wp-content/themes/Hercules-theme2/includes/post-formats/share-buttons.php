...
<div class="share-buttons">
	...
	?>		
	<span class="twitter">
		<a href="http://twitter.com/share?url=<?php echo $permalink; ?>&text=<?php echo get_the_title().' - '.$permalink; ?>" class="twitter-share-button" data-count="horizontal"><?php _e('Tweet this article', HS_CURRENT_THEME); ?></a>

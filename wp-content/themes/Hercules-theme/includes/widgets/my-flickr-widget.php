...
<script>
  jQuery('#flickr').jflickrfeed({
    ...
    itemTemplate: '<li class="flickr_li span3"><a class="thumbnail" rel="prettyPhoto[flickr]" href="{{image_b}}" title="{{title}}"><img class="flickr_img" src="{{image_s}}" alt="{{title}}" /></a></li>'
  }, function(data) {
    ...
    jQuery(".flickr_li:nth-child(4n+1)").addClass("nomargin");
  });
</script>

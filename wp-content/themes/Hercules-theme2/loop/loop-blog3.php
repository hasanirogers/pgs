...
<ul class="posts-grid row-fluid unstyled "><?php elseif($counter==3): ?><?php endif; ?>
...
<?php if($counter==3): ?></ul><!-- /.row cols2 -->
<?php $counter=0;endif;$counter++;endwhile;if($counter==3):?><!-- /.row cols2 --><?php endif;endif; ?>
